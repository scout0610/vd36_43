...
void main()
{
	...
	// Luu vao file
	f = fopen("F:\\project1\\vd36_43\\vd36_43_codec\\text1.txt", "w");
	fprintf(f, "%d\n", n);
	for (i = 0; i < n; i++)
		fprintf(f, "%f\n", a[i]);
	fclose(f);
	...
	f = fopen("F:\\project1\\vd36_43\\vd36_43_codec\\text1.txt", "r");
	fscanf(f, "%d", &n);
	for (i = 0; i < n; i++)
		fscanf(f, "%f", &a[i]);
	fclose(f);
	...
	// Luu vao file
	f = fopen("F:\\project1\\vd36_43\\vd36_43_codec\\text2.txt", "w");
	fprintf(f, "%d\n", n);
	for (i = 0; i < n; i++)
		fprintf(f, "%f\n", a[i]);
	fclose(f);
